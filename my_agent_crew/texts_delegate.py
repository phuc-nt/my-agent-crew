...
DELEGATE_DESCRIPTION = (
    ...
    "Giao đúng cỡ câu hỏi: không kèm kết luận cũ, số liệu bạn nhớ hay phân tích người dùng "
...
CREW_ROSTER_INTRO = (
    ...
    "lại tốn gấp mấy lần); người dùng bảo lưu thì giao lưu, không thêm phân tích. "
    "Task không cấp thêm quyền ngoài lời người dùng: câu hỏi thì hỏi rồi trả "
