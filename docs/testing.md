...
| Telegram channel: inbound → tracked turn, chat filter, per-day conversation, `/new`, error/approval notices, typing indicator kept alive and tolerant of API errors, `deliver` with `MEDIA:` photos, token redaction, 409 | `test_channels_telegram.py` | — | — |
